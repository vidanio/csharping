    ...
    public partial class MainForm : Form
    {
        ...
        private async void handlerDevices_Click(object sender, EventArgs e)
        {
            if (sender.GetType() == typeof(PictureBox))
            {
                ...
                if (type == "E") // encoder
                {
                    ...
                    {
                        case "Inactive":
                            if (MessageBox.Show("Sure you want to deactivate this Sender?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                            {
                                await webClient.GetHTTPStringPTaskAsync(new Uri(String.Format("{0}user.cgi?cmd=4&rnd={1}&enc={2}&active=0", ServerURL, rnd, random)));
                            }
                            break;
                        case "Active":
                            if (MessageBox.Show("Sure you want to activate this Sender?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                            {
                                await webClient.GetHTTPStringPTaskAsync(new Uri(String.Format("{0}user.cgi?cmd=4&rnd={1}&enc={2}&active=1", ServerURL, rnd, random)));
                            }
                            break;
                        case "Delete":
                            if (MessageBox.Show("Sure you want to delete this Sender?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                            {
                ...
                else // decoder
                {
                    ...
                    {
                        case "Inactive":
                            if (MessageBox.Show("Sure you want to deactivate this Receiver?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                            {
                            ...
                            break;
                        case "Active":
                            if (MessageBox.Show("Sure you want to activate this Receiver?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                            {
                            ...
                            break;
                        case "Delete":
                            if (MessageBox.Show("Sure you want to delete this Receiver?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                            {
        ...
        private void DrawDevicesPanel(List<Device> devices, Panel panel)
        {
            ...
            foreach (Device device in devices)
            {
                ...
                tooltip.SetToolTip(label0, (device.Type == "E") ? "Copy encoder smart url": "Copy Streaming URL");
                ...
                tooltip.SetToolTip(label2, "time connected");
                ...
                tooltip.SetToolTip(label3, "bitrate in Kbps");
                ...
                tooltip.SetToolTip(pic0, (device.Active) ? "Deactivate device" : "Activate device");
                ...
                tooltip.SetToolTip(pic1, (device.Working) ? "connected device" : "disconnected device");
                ...
                tooltip.SetToolTip(pic2, "Delete device");
                ...
                tooltip.SetToolTip(pic3, "Edit device");
                ...
                if (device.Type == "E")
                {
                    ...
                    tooltip.SetToolTip(pic4, "Add a New Receiver");
                ...
                else // PictureBox
                {
                    ...
                    switch (words[0])
                    {
                        ...
                        case "Working":
                            ...
                            tooltip.SetToolTip(crtl, (device.Working) ? "connected device" : "disconnected device");
                            break;
                    }
                }
            }
