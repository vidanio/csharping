...
namespace UIControlCode
{
    public partial class MainForm : Form
    {
        ...
        string[] AdminMonHeaders = new string[] { "User", "GBytes", "Hours" }; //User ; GBytes ; Hours
        string[] UserDayHeaders = new string[] { "Day", "MBytes", "Minutes" }; // Day ; MBytes ; Minutes
        string[] UserMonHeaders = new string[] { "Month", "GBytes", "Hours" }; // Month ; GBytes ; Hours
        string[] UserNowHeaders = new string[] { "Decoder", "Kbps", "Minutes", "MBytes" }; // Decoder ; Kbps ; Minutes ; Mbytes
    }
}
