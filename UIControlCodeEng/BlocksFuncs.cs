...
namespace UIControlCode
{
    public partial class MainForm : Form
    {
        ...
        private void DrawLoggingBlock(int x, int y, string text)
        {
            ...
            tooltip.SetToolTip(loggingPicture, "Change your Password");
        ...
        private void DrawAdminsPanelBlock(int x, int y, int sizex, int sizey)
        {
            ...
            lblTitleAdmins.Text = "List of Administrators";
            ...
            tooltip.SetToolTip(addAdmin, "Add a New Admin");
        ...
        private void DrawUsersPanelBlock(int x, int y, int sizex, int sizey)
        {
            ...
            lblTitleUsers.Text = "List of Users";
            ...
            tooltip.SetToolTip(addUser, "Add a New User");
        ...
        private void DrawDevicesPanelBlock(int x, int y, int sizex, int sizey)
        {
            ...
            lblTitleDevices.Text = "List of Devices";
            ...
            tooltip.SetToolTip(addDevice, "Add a New Sender");
        ...
        private DataGridView DrawStatsTableBlock(int x, int y, int sizex, int sizey, string csv, string sum)
        {
            ...
            if (sum != "user_now")
            {
                ...
                cboxMonth = CreateComboBox("Month", MonthNames, x + sizex - 90, y - 24, 90, 21, "Month_" + sum, today.Month - 1);
                object[] years = new object[] { today.Year-2, today.Year-1 , today.Year };
                cboxYear = CreateComboBox("Year", years, x + sizex - 153, y - 24, 60, 21, "Year_" + sum, 2);
