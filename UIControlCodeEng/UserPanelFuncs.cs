    ...
    public partial class MainForm : Form
    {
        ...
        private async void handlerUsers_Click(object sender, EventArgs e)
        {
            if (sender.GetType() == typeof(PictureBox))
            {
                ...
                {
                    case "Inactive":
                        if (MessageBox.Show("Sure you want to deactivate this User?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                        {
                        ...
                        break;
                    case "Active":
                        if (MessageBox.Show("Sure you want to activate this User?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                        {
                        ...
                        break;
                    case "Delete":
                        if (MessageBox.Show("Sure you want to delete this User?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                        {
        ...
        private void DrawUsersPanel(List<User> users, Panel panel)
        {
            ...
            foreach (User user in users)
            {
                ...
                tooltip.SetToolTip(label0, "Select User");
                ...
                tooltip.SetToolTip(pic0, (user.Active) ? "Deactivate user" : "Activate user");
                ...
                tooltip.SetToolTip(pic2, "Delete user");
                ...
                tooltip.SetToolTip(pic3, "Edit user");
