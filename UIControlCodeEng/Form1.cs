    ...
    public partial class MainForm : Form
    {
        ...
        private async void logInToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (formLogin.ShowDialog() == DialogResult.OK)
            {
                ...
                statusLblMsg.Text = String.Format("Trying to connect to Server {0} ...", formLogin.LoginServer);
                ...
                if (result == null)
                {
                    ...
                    statusLblMsg.Text = String.Format("Error connecting to Server {0}", formLogin.LoginServer);
                ...
                statusLblMsg.Text = String.Format("Connected to Server {0} as {1}", formLogin.LoginServer, LoginName);
        ...
        private async void timer_Tick(object sender, EventArgs e)
        {
            ...
            {
                statusLblMsg.ForeColor = Color.Red;
                statusLblMsg.Text = String.Format("ERROR: Disconnected from Server {0}", LoginServer);
                timer.Start();
                return;
            }
            statusLblMsg.ForeColor = Color.Green;
            statusLblMsg.Text = String.Format("Connected to Server {0} as {1}", LoginServer, LoginName);
